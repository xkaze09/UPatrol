...
import 'create_report_anon_model.dart';
export 'create_report_anon_model.dart';

class CreateReportAnonWidget extends StatefulWidget {
  const CreateReportAnonWidget({Key? key}) : super(key: key);

  @override
  _CreateReportAnonWidgetState createState() => _CreateReportAnonWidgetState();
}

class _CreateReportAnonWidgetState extends State<CreateReportAnonWidget> {
  late CreateReportAnonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateReportAnonModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.base64output1 = await actions.convertImageFileToBase64(
        _model.uploadedLocalFile1,
      );
      _model.reportImage = _model.uploadedLocalFile1;
      _model.base64Image = _model.base64output1!;
    });
                                  ...
                                  defaultLocation: LatLng(0.0, 0.0));
                          {
                            ...
                            try {
                              ...
                              selectedUploadedFiles =
                                  _model.reportImage!.bytes!.isNotEmpty
                                      ? [_model.reportImage!]
                                      : <FFUploadedFile>[];
                        ...
                        Align(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller:
                              ...
                              _model.categoryDropdownValue1 ??= 'Undefined',
                            ),
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller:
                                _model.categoryDropdownValueController2 ??=
                                    FormFieldController<String>(
                              _model.categoryDropdownValue2 ??= 'Undefined',
                            ),
                            options: List<String>.from(
                                ['Undefined', 'Electrical', 'Garbage', 'Fire']),
                            optionLabels: [
