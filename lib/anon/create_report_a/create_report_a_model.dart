...
import 'create_report_a_widget.dart' show CreateReportAWidget;
...
class CreateReportAModel extends FlutterFlowModel<CreateReportAWidget> {
  ///  Local state fields for this page.

  FFUploadedFile? reportImageo;
  ...
  // Stores action output result for [Custom Action - reverseGeocode] action in CreateReport-A widget.
  String? address1;
  bool isDataUploading1 = false;
  FFUploadedFile uploadedLocalFile1 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  // Stores action output result for [Custom Action - convertImageFileToBase64] action in CreateReport-A widget.
  String? baseImage1;
