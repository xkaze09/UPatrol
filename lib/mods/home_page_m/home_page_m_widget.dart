...
import 'home_page_m_model.dart';
export 'home_page_m_model.dart';

class HomePageMWidget extends StatefulWidget {
  const HomePageMWidget({Key? key}) : super(key: key);

  @override
  _HomePageMWidgetState createState() => _HomePageMWidgetState();
}

class _HomePageMWidgetState extends State<HomePageMWidget>
    with TickerProviderStateMixin {
  late HomePageMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageMModel());
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      Align(
                        alignment: AlignmentDirectional(0.00, -4.71),
                        child: Container(
                          width: 394.0,
                          height: 173.0,
