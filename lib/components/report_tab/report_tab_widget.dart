...
import 'report_tab_model.dart';
export 'report_tab_model.dart';
...
class _ReportTabWidgetState extends State<ReportTabWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportTabModel());
    ...
    _model.projectURLController ??=
        TextEditingController(text: widget.report?.address);
                                  ...
                                  Padding(
                                    ...
                                    child: FutureBuilder<UsersRecord>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final clonableURLUsersRecord =
                                            snapshot.data!;
                                        return TextFormField(
                                          controller:
                                              _model.clonableURLController ??=
                                                  TextEditingController(
                                            text: clonableURLUsersRecord
                                                .displayName,
                                          ),
                                          focusNode:
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: Text(
                                                                'Verify Report'),
                                                            content: Text(
                                                                'Would you like to verify this report as correct?'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
