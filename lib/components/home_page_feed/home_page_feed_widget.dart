...
import 'home_page_feed_model.dart';
export 'home_page_feed_model.dart';

class HomePageFeedWidget extends StatefulWidget {
  const HomePageFeedWidget({
    Key? key,
    this.reportsList,
  }) : super(key: key);
...
class _HomePageFeedWidgetState extends State<HomePageFeedWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageFeedModel());
