...
class HomePageFeedMWidget extends StatefulWidget {
  ...
  @override
  State<HomePageFeedMWidget> createState() => _HomePageFeedMWidgetState();
}
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final repHist =
                                            widget.allReports!.toList();
                                        return ListView.builder(
                                          padding: EdgeInsets.zero,
                                          scrollDirection: Axis.vertical,
                                          itemCount: repHist.length,
                                          itemBuilder: (context, repHistIndex) {
                                            final repHistItem =
                                                repHist[repHistIndex];
                                            return Align(
                                              alignment: AlignmentDirectional(
                                                  -1.0, 0.0),
                                              child: Padding(
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              if (!repHistItem.isResolved && repHistItem.isVerified)
                                                                                Align(
                                                                                  alignment: AlignmentDirectional(0.22, -0.96),
                                                                                  child: FlutterFlowIconButton(
                                                                                    borderColor: Color(0x00CCCCCC),
