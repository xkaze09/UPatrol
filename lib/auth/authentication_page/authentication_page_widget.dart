...
class _AuthenticationPageWidgetState extends State<AuthenticationPageWidget>
  ...
  void initState() {
    ...
    _model.backgroundController ??= TextEditingController();
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 20.0, 0.0, 0.0),
                                    child: TextFormField(
                                      key: ValueKey('emailAddress_Login_dfbk'),
                                      controller:
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: TextFormField(
                                      key: ValueKey('password_Login_4qxs'),
                                      controller:
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      key: ValueKey('Button-Login_708q'),
                                      onPressed: () async {
                                        ...
                                        context.goNamedAuth(
                                            'connectingPage', context.mounted);
                                      },
                                      text: 'Sign in',
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed('requestResetPage');
                                      },
